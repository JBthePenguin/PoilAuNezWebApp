"""
Django settings for poilaunezdjango project.
...
SECRET_KEY = 'osu@j_s^ke&orsz3752(_7se5&+4$#(f(i^2+x!ydmhtorl$k-'
...
ROOT_URLCONF = 'poilaunezdjango.urls'
...
WSGI_APPLICATION = 'poilaunezdjango.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'db_poilaunez', # le nom de notre base de donnees à créer
        'USER': 'poilaunez', # le nom de l'utilisateur à créer
        'PASSWORD': 'cool',
        'HOST': 'localhost',
        'PORT': '5432',
    }
